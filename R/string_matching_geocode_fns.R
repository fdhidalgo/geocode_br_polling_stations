...
match_stbairro_agrocnefe_muni <- function(locais_muni, agrocnefe_st_muni, agrocnefe_bairro_muni) {
        ...
        data.table(
                local_id, mindist_st_agrocnefe, match_st_agrocnefe, match_long_st_agrocnefe, match_lat_st_agrocnefe,
...
predict_distance <- function(cnefe_stbairro_match, inep_string_match, schools_cnefe_match,
        ...
        cnefe_stbairro <- cnefe_stbairro_match |>
                ...
                mutate(
                        var = case_when(
                                grepl("long", name) ~ "long",
                                grepl("lat", name) ~ "lat",
                                grepl("mindist", name) ~ "mindist"
                        ),
                        type = case_when(
                                grepl("_st_", name) ~ "st_cnefe",
        ...
        schools_cnefe <- schools_cnefe_match |>
                ...
                mutate(
                        ...
                        type = case_when(
                                grepl("_name", name) ~ "schools_cnefe_name",
        ...
        inep <- inep_string_match |>
                ...
                mutate(
                        ...
                        type = case_when(
                                grepl("_name", name) ~ "schools_inep_name",
        ...
        cvfolds <- group_vfold_cv(training_set,

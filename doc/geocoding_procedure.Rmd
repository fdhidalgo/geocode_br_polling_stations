...
[^5]: See the `finetune` package reference [materials](https://finetune.tidymodels.org/reference/tune_race_anova.html) for more information on adaptive resampling.
...
example_cnefe10_schools <- filter(schools_cnefe10_match, local_id == example_id)
example_cnefe22_schools <- filter(schools_cnefe22_match, local_id == example_id)
example_agrocnefe <- filter(agrocnefe_stbairro_match, local_id == example_id)
example_cnefe10 <- filter(cnefe10_stbairro_match, local_id == example_id)
example_cnefe22 <- filter(cnefe22_stbairro_match, local_id == example_id)
example_string_match <- tibble(match_type = c(
  ...
  left_join(filter(model_predictions, local_id == example_id))

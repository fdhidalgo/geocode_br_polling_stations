...
-   The candidate's quality score from the source that produced it: the length-normalized Jaro-Winkler string distance for the string-matched sources, and the uncertainty radius for `geocodebr`. Lower is better in both cases.
